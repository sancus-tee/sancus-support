...
function(generate_symtab output)
    ...
    cmake_parse_arguments(ARG "" "" "INPUTS;STD_LIBS;EXTRA_SYMS" ${ARGN})
    ...
    foreach (sym ${ARG_EXTRA_SYMS})
        set(options ${options} --add-symbol ${sym})
    endforeach ()
...
function(add_executable_with_symtab name)
    cmake_parse_arguments(ARG "" "" "SOURCES;LIBS;EXTRA_SYMS" ${ARGN})
    set(sources ${ARG_SOURCES})
    set(libs ${ARG_LIBS})
    set(extras ${ARG_EXTRA_SYMS})
    ...
    generate_symtab(symtab.c
                    INPUTS ${reloc_exec} ${libs}
                    STD_LIBS c
                    EXTRA_SYMS ${extras})
